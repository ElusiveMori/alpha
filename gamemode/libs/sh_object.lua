...
local recursive_copy
local recursive_inherit

function object:initialize()
	recursive_copy = alpha.util.recursive_copy
	recursive_inherit = alpha.util.recursive_inherit
end
...
object:hook_add("PostInitialize", function()
	alpha.include_directory_recursive(alpha.folder_name .. "/gamemode/classes")
